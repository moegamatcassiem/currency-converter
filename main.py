...
currency_cb2.place(x=250, y=50)

Label(root, bg="black", fg="white", text='Enter Amount:').place(x=65, y=100)
ent1 = Entry(root)
ent1.place(x=200, y=100)
ent1.focus()
Label(root, bg="black", fg="white", text='Converted Amount:').place(x=65, y=150)
...
Button(root, text="convert", borderwidth=3, bg="black", fg="white", command=perform).place(x=170, y=200)
des = Button(root, text="exit", borderwidth=3, bg="black", fg="white", command=exit).place(x=175, y=250)
